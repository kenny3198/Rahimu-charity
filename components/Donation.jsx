...
const DonationSection = () => {
  ...
  return (
    <section id='donate' className=" bg-white text-amber-900 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="md:text-4xl text-3xl sm:text-5xl font-extrabold 
        mb-8 leading-tight">
          Support Our Cause
        </h2>
        <p className="md:text-lg text-sm sm:text-xl mb-12 text-amber-900">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="bg-white-600 bg-opacity-10 backdrop-filter backdrop-blur-sm rounded-lg p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
            <h3 className="md:text-2xl text-xl font-bold mb-4 text-amber-900">Finland Bank Account</h3>
          ...
          {/* Ghana Bank Account */}
          <div className="bg-white-600 bg-opacity-10 backdrop-filter
           backdrop-blur-sm rounded-lg p-8 shadow-xl hover:shadow-2xl
            transition-all duration-300 transform hover:-translate-y-1">
            <h3 className="md:text-2xl text-xl font-bold mb-4 text-amber-900">Ghana Bank Account</h3>
            <p className="text-lg mb-2">
        ...
        <div className="mt-12 bg-white-600 bg-opacity-10 backdrop-filter backdrop-blur-sm rounded-lg p-8 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1">
          <h3 className="md:text-2xl text-xl font-bold mb-4 text-amber-900">MTN Mobile Money (Ghana)</h3>
          <p className="text-lg">
            <span className="font-semibold">Mobile Money Number:</span> +233538861461
          </p>
        </div>

        <p className="text-base sm:text-lg mt-12 text-amber-900">
